 ...
 * sends commands as `atomictest://` deep links, which RN's Linking handles, and the iOS module
 * exposes no events — constructing an emitter for it would warn about the missing
